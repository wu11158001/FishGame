...
public class AddressableManagement : SingletonMonoBehaviour<AddressableManagement>
{
    ...
    /// 開啟設置介面
    /// </summary>
    public async void OpenSettingView(Action closeAction = null)
    {
        ViewEnum view = ViewEnum.SettingView;
        ...
        await OpenView(
            ...
            callback: (viewObj) =>
            {
                if (viewObj != null)
                {
                    viewObj.GetComponent<SettingView>().SetData(closeAction: viewCloseAction);
                }
            });
    }
    ...
    /// 開啟編輯頭像介面
    /// </summary>
    public async void OpenEditNicknameView(Action closeAction = null)
    {
        ViewEnum view = ViewEnum.EditNicknameView;
        ...
        await OpenView(
            ...
            callback: (viewObj) =>
            {
                if (viewObj != null)
                {
                    viewObj.GetComponent<EditNicknameView>().SetData(closeAction: viewCloseAction);
                }
            });
    }
    ...
    /// 開啟商店介面
    /// </summary>
    public async void OpenShopView(ShopSwitchEnum defaultShopType = ShopSwitchEnum.TurretTag, Action closeAction = null)
    {
        ViewEnum view = ViewEnum.ShopView;
        ...
        await OpenView(
            ...
            callback: (viewObj) =>
            {
                if (viewObj != null)
                {
                    viewObj.GetComponent<ShopView>().SetData(defaultShopType: defaultShopType, closeAction: viewCloseAction);
                }
            });
    }
